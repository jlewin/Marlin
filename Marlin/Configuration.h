...
#define STRING_CONFIG_H_AUTHOR "(lewin76, default config)" // Who made the changes.
...
// [ X, Y, Z and E]
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 2300, 168}  // default steps per unit for Ultimaker
